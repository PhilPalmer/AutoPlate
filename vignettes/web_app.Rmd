...
| Example           |  |
| Required columns  |  |
| Plate number      | The end of the filename can be used to specify the filename eg `n1.xls` for plate 1. If numbers are not provided the filename will be used instead |
