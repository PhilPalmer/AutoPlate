...
[![Codecov test coverage](https://codecov.io/gh/PhilPalmer/AutoPlate/branch/golem/graph/badge.svg)](https://codecov.io/gh/PhilPalmer/AutoPlate?branch=golem)
...
Load your dataset, define the dose-response model (DRM) and the virus to plot:
